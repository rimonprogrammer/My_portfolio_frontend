            ...
            <div className="col-md-7">
                ...
                <div data-aos="fade-right">
                    <p style={props.mode} className='animate p-2 rounded-3 paragraph user-select-none' data-aos="fade-right">
                        I'm a professional FrontEnd web Application developer with 1+ years of experience.
                        Client satisfaction is my first priority, & as a professional junior web developer, new technology learning is my passion.
                    </p>
                </div>
